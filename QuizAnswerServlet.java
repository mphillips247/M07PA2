...
public class QuizAnswerServlet extends HttpServlet {
    public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        //check user answers, update the count
        if (20 + 6 == first)
            count++;
        if (27 + 6 == second)
            count++;
        ...
        //display each question and user's answer if it's correct or wrong
        ...
        //display the total count of correct answers
